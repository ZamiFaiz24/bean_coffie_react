  ...
  if (isCollapsed) {
    ...
    return (
      <div className="w-16 bg-white border-r border-coffee-200 flex flex-col items-center py-4 space-y-4">
        ...
        {/* Logo */}
        <div className="w-10 h-10 bg-coffee-600 rounded-lg flex items-center justify-center text-white">
        ...
        <div className="flex-1 flex flex-col space-y-2">
          <Link href="/cashier" title="Dashboard">
            <button className="hover:bg-coffee-100 text-coffee-700 rounded-lg p-2 transition">
    ...
    <div className="w-64 bg-white border-r border-coffee-200 flex flex-col h-full">
      ...
      <nav className="flex-1 p-4 space-y-2">
        ...
        <Link href="/cashier" className="block">
          <Button variant="ghost" className="w-full justify-start text-coffee-800 hover:bg-coffee-100">
