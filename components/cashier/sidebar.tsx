      ...
      <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-4">
        ...
        <div className="flex-1 flex flex-col space-y-2">
          <Link href="/cashier" title="Dashboard">
            <button className="hover:bg-emerald-50 text-gray-600 rounded-lg p-2 transition">
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <nav className="flex-1 p-4 space-y-2">
        <div className="text-xs font-semibold text-emerald-700 px-3 py-2 uppercase tracking-wide">
          Menu
        </div>
        ...
        {/* History Section */}
        <div className="text-xs font-semibold text-emerald-700 px-3 py-2 uppercase tracking-wide mt-6">
          History
        </div>
